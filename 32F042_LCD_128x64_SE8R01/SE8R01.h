...
#define CEq_LO()					GPIOA->BRR 	|=1<<3
#define CEq_HI()					GPIOA->BSRR |=1<<3

#define SPI1_DR_8bit 			*((__IO uint8_t *)&SPI1->DR)		// Limit for spi bus 8 bit

// BYTE type definition

#define READ_SE_REG     0x00  // Define read command to register	READ_REG 
#define WRITE_SE_REG    0x20  // Define write command to register	WRITE_REG
...
#define TX_PLOAD_WIDTH  				6  			// max 32 unsigned chars TX payload
